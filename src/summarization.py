...
def main():
    ...
    model = get_pretrained_model(data_args, model_args, len(tokenizer))
    ...
    train_dataset, eval_dataset, predict_dataset = get_dataset(data_args, model_args, training_args, tokenizer)
